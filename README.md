# Para construir o ambiente use o comando "python -m virtualenv {nomedoambiente}" (note que este comando é para a base linux, para windows use no lugar de virtualenv => venv)
